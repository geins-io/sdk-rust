...
pub struct OrderPeriodCapture {
    #[serde(rename = "CaptureId", skip_serializing_if = "Option::is_none")]
    pub capture_id: Option<uuid::Uuid>,
    #[serde(rename = "OrderPaymentId", skip_serializing_if = "Option::is_none")]
    pub order_payment_id: Option<uuid::Uuid>,
    ...
    #[serde(rename = "CapturedItemTotal", skip_serializing_if = "Option::is_none")]
    pub captured_item_total: Option<f64>,
    #[serde(rename = "CapturedShippingFee", skip_serializing_if = "Option::is_none")]
    pub captured_shipping_fee: Option<f64>,
    #[serde(rename = "CapturedPaymentFee", skip_serializing_if = "Option::is_none")]
    pub captured_payment_fee: Option<f64>,
    #[serde(rename = "CapturedDiscount", skip_serializing_if = "Option::is_none")]
    pub captured_discount: Option<f64>,
    #[serde(rename = "CapturedBalance", skip_serializing_if = "Option::is_none")]
    pub captured_balance: Option<f64>,
    ...
    #[serde(rename = "ShippingName", skip_serializing_if = "Option::is_none")]
    pub shipping_name: Option<String>,
    #[serde(rename = "TrackingUri", skip_serializing_if = "Option::is_none")]
    ...
    pub rows: Option<Vec<crate::models::OrderPeriodCaptureRow>>,
...
impl OrderPeriodCapture {
    pub fn new() -> OrderPeriodCapture {
        OrderPeriodCapture {
            capture_id: None,
            ...
            description: None,
            processed_on: None,
            captured_item_total: None,
            captured_shipping_fee: None,
            captured_payment_fee: None,
            captured_discount: None,
