...
/// ProductParameterPeriodModelsPeriodWritePeriodProductParameterPredefinedValue : A predefined value for a product parameter.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ProductParameterPeriodModelsPeriodWritePeriodProductParameterPredefinedValue {
...
impl ProductParameterPeriodModelsPeriodWritePeriodProductParameterPredefinedValue {
    /// A predefined value for a product parameter.
    pub fn new() -> ProductParameterPeriodModelsPeriodWritePeriodProductParameterPredefinedValue {
        ProductParameterPeriodModelsPeriodWritePeriodProductParameterPredefinedValue {
            parameter_id: None,
