...
/// ProductPeriodModelsPeriodReadPeriodShippingFee : A shipping fee for a product item.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ProductPeriodModelsPeriodReadPeriodShippingFee {
...
impl ProductPeriodModelsPeriodReadPeriodShippingFee {
    /// A shipping fee for a product item.
    pub fn new() -> ProductPeriodModelsPeriodReadPeriodShippingFee {
        ProductPeriodModelsPeriodReadPeriodShippingFee {
            market: None,
            country: None,
            service: None,
            service_id: None,
