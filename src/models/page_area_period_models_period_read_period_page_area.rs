...
/// PageAreaPeriodModelsPeriodReadPeriodPageArea : The API-version of the PageArea class



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct PageAreaPeriodModelsPeriodReadPeriodPageArea {
    ...
    pub containers: Option<Vec<crate::models::PageAreaPeriodModelsPeriodReadPeriodPageWidgetContainer>>,
}

impl PageAreaPeriodModelsPeriodReadPeriodPageArea {
    /// The API-version of the PageArea class
    pub fn new() -> PageAreaPeriodModelsPeriodReadPeriodPageArea {
        PageAreaPeriodModelsPeriodReadPeriodPageArea {
            index: None,
            name: None,
            family_id: None,
            settings: None,
