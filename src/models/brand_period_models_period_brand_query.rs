...
/// BrandPeriodModelsPeriodBrandQuery : A brand query.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct BrandPeriodModelsPeriodBrandQuery {
    ...
    #[serde(rename = "BrandIds", skip_serializing_if = "Option::is_none")]
...
impl BrandPeriodModelsPeriodBrandQuery {
    /// A brand query.
    pub fn new() -> BrandPeriodModelsPeriodBrandQuery {
        BrandPeriodModelsPeriodBrandQuery {
            created_after: None,
            brand_ids: None,
            external_ids: None,
        }
