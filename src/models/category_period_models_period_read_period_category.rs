...
/// CategoryPeriodModelsPeriodReadPeriodCategory : An existing category.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CategoryPeriodModelsPeriodReadPeriodCategory {
    ...
    pub descriptions: Option<Vec<crate::models::SharedPeriodModelsPeriodLocalizableContent>>,
    /// The Google Taxonomy category path for the category, if any.
    #[serde(rename = "GoogleCategoryPath", skip_serializing_if = "Option::is_none")]
    pub google_category_path: Option<String>,
}

impl CategoryPeriodModelsPeriodReadPeriodCategory {
    /// An existing category.
    pub fn new() -> CategoryPeriodModelsPeriodReadPeriodCategory {
        CategoryPeriodModelsPeriodReadPeriodCategory {
            category_id: None,
