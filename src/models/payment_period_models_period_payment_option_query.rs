...
pub struct PaymentPeriodModelsPeriodPaymentOptionQuery {
...
impl PaymentPeriodModelsPeriodPaymentOptionQuery {
    pub fn new() -> PaymentPeriodModelsPeriodPaymentOptionQuery {
        PaymentPeriodModelsPeriodPaymentOptionQuery {
            site_id: None,
            email: None,
