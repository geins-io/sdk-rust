...
/// ProductParameterPeriodModelsPeriodReadPeriodProductParameter : An existing product parameter.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ProductParameterPeriodModelsPeriodReadPeriodProductParameter {
...
impl ProductParameterPeriodModelsPeriodReadPeriodProductParameter {
    /// An existing product parameter.
    pub fn new() -> ProductParameterPeriodModelsPeriodReadPeriodProductParameter {
        ProductParameterPeriodModelsPeriodReadPeriodProductParameter {
            parameter_id: None,
            group_id: None,
            group_name: None,
            parameter_type: None,
