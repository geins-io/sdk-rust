...
/// ProductParameterPeriodModelsPeriodWritePeriodProductParameter : A product parameter to create or update.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ProductParameterPeriodModelsPeriodWritePeriodProductParameter {
...
impl ProductParameterPeriodModelsPeriodWritePeriodProductParameter {
    /// A product parameter to create or update.
    pub fn new() -> ProductParameterPeriodModelsPeriodWritePeriodProductParameter {
        ProductParameterPeriodModelsPeriodWritePeriodProductParameter {
            parameter_id: None,
            group_id: None,
            parameter_type: None,
            name: None,
