...
/// CategoryPeriodModelsPeriodCategoryQuery : A query to filter categories by.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CategoryPeriodModelsPeriodCategoryQuery {
...
impl CategoryPeriodModelsPeriodCategoryQuery {
    /// A query to filter categories by.
    pub fn new() -> CategoryPeriodModelsPeriodCategoryQuery {
        CategoryPeriodModelsPeriodCategoryQuery {
            created_after: None,
            category_ids: None,
        }
    }
