...
/// ProductParameterPeriodModelsPeriodWritePeriodProductParameterValue : A parameter value for a product.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ProductParameterPeriodModelsPeriodWritePeriodProductParameterValue {
...
impl ProductParameterPeriodModelsPeriodWritePeriodProductParameterValue {
    /// A parameter value for a product.
    pub fn new() -> ProductParameterPeriodModelsPeriodWritePeriodProductParameterValue {
        ProductParameterPeriodModelsPeriodWritePeriodProductParameterValue {
            product_id: None,
            parameter_id: None,
            value: None,
