...
/// CategoryPeriodModelsPeriodWritePeriodCategory : A category to create or update.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CategoryPeriodModelsPeriodWritePeriodCategory {
...
impl CategoryPeriodModelsPeriodWritePeriodCategory {
    /// A category to create or update.
    pub fn new() -> CategoryPeriodModelsPeriodWritePeriodCategory {
        CategoryPeriodModelsPeriodWritePeriodCategory {
