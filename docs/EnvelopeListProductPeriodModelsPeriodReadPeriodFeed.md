# EnvelopeListProductPeriodModelsPeriodReadPeriodFeed
...
**resource** | Option<[**Vec<crate::models::ProductPeriodModelsPeriodReadPeriodFeed>**](Product.Models.Read.Feed.md)> | The resource on which the action was taken. | [optional]
